...
// For Qoder:       writes {workDir}/AGENTS.md  (Qoder CLI reads AGENTS.md natively; skills discovered natively from .qoder/skills/)
...
func buildMetaSkillContent(provider string, ctx TaskContextForEnv) string {
	...
	if len(ctx.AgentSkills) > 0 {
		...
		case "codex", "copilot", "opencode", "openclaw", "pi", "cursor", "kimi", "kiro", "antigravity", "qoder":
			// Codex, Copilot, OpenCode, OpenClaw, Pi, Cursor, Kimi, Kiro,
			// Antigravity, and Qoder discover skills natively from their respective paths.
